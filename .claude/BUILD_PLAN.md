...
`BLOCKED: 10 — "What Our Guests Say" is unmanaged and currently shows fabricated testimonials.`
...
`BLOCKED: 10 — the review scraper imports search snippets, not reviews.`
